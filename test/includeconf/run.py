...
tests = [
    {"name": "C", "cmdline": ["-C _config.inc"], "not-numbered": True},
    {"name": "C-C", "cmdline": ["-C _config.inc -C _config.inc"], "not-numbered": True},
    {"name": "C-C2", "cmdline": ["-C _config.inc -C _config2.inc"]},
    {"name": "C-default", "cmdline": ["-t html -C _config2.inc"]},
    {"name": "C-empty", "cmdline": ["-t html -C _empty.inc"], "not-numbered": True},
    {"name": "C-not-found", "cmdline": ["-t html -C XXX.inc"], "not-numbered": True},
    {"name": "C-text", "cmdline": ["-t html -C _text.inc"], "not-numbered": True},
    {"name": "C-targeted-inside", "cmdline": ["-t html -C _targeted.inc"]},
    {"name": "C-nesting", "cmdline": ["-C _sub_include.inc"]},
    {"name": "C-nesting-folder", "cmdline": ["-C folder/_folder.inc"]},
    {
