...
So today is 20100806 on the ISO \texttt{YYYYMMDD} format.

You can also specify the date format with the \%? flags,
as \texttt{\%\%date(\%m-\%d-\%Y)} which gives: 08-06-2010.
...
% LaTeX2e code generated by txt2tags 2.6b (http://txt2tags.sf.net)
