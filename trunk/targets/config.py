"""
Copy your targets in this directory, and add them to the TARGETS_LIST list.
"""
...
TARGETS_LIST = ['txt', 'aat', 'aap', 'aas', 'aatw', 'aapw', 'aasw', 'rst', 'html', 'html5', 'xhtml', 'xhtmls', 'htmls', 'wp', 'slidy', 'db', 'tex', 'texs', 'rtf', 'mgp', 'man', 'adoc', 'csv', 'csvs', 'doku', 'moin', 'pm6', 'red', 'spip', 'txt2t', 'bbcode', 'creole', 'dbk', 'gwiki', 'lout', 'md', 'mom', 'utroff', 'ods', 'pmw', 'sgml', 'tml', 'wiki', 'vimwiki']
