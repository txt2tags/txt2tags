...
(function(){
	...
	edButtons[21] = new qt.TagButton('u','u','__','__','u'),
	//edButtons[30] = new qt.LinkButton(), // special case
	edButtons[25] = new qt.TagButton('del','del','--','--','d'),
	edButtons[26] = new qt.TagButton('H2','H2','== ',' ==','b'),
	edButtons[27] = new qt.TagButton('H3','H3','=== ',' ===','b'),
	edButtons[30] = new qt.TagButton('link','link','[',']','l'),
	...
	edButtons[120] = new qt.TagButton('more','comment','% ','','t'),
