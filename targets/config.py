...
#TARGETS_LIST = ['txt', 'aat', 'aap', 'aas', 'aatw', 'aasw', 'rst', 'html', 'html5', 'xhtml', 'xhtmls', 'htmls', 'wp', 'db', 'tex', 'texs', 'rtf', 'mgp', 'man', 'adoc', 'csv', 'csvs', 'doku', 'moin', 'pm6', 'red', 'spip', 'txt2t', 'bbcode', 'creole', 'dbk', 'gwiki', 'lout', 'md', 'mom', 'ods', 'pmw', 'sgml', 'tml', 'wiki', 'vimwiki']
